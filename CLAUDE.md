...
**Field:** International/Trade Economics, Economic Complexity, Fintech
**Branch:** main
...
|-----------|------|--------|-------------|
| Paper | `paper/main.tex` | not started | Stablecoin Opportunity Map — complexity + payment frictions |
| Data | `scripts/R/` | not started | Comtrade + CEPII + payment friction data |
